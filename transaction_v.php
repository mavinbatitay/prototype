				...
				<div class="card-body">
					...
					<form id="frmInputs">
						<div class="form-floating" id="divAccountno">
							<input type="text" name="txtnmAccountno" id="inputnmAccountno" class="form-control" placeholder="Account No." autocomplete="off" required style="background-color: #cccaca; border-color: transparent;">
						...
						<div class="form-floating">
							<input type="text" name="txtnmAmount" id="inputnmAmount" class="form-control" placeholder="Amount" autocomplete="off" required style="background-color: #cccaca; border-color: transparent;">
							<label for="inputnmAmount">Amount</label>
						</div>
						<div class="form-floating">
							<input type="date" name="txtnmDate" class="form-control" id="inputnmDate" placeholder="Date" autocomplete="off" required style="background-color: #cccaca; border-color: transparent;">
						...
						<div class="form-floating">
							<input type="text" name="txtnmCheckno" class="form-control" id="inputnmCheckno" placeholder="Check No." autocomplete="off" required style="background-color: #cccaca; border-color: transparent;">
						...
						<div id="divAddtl" style="background-color: gray; display: none;" class="card">
							<div class="card-body">
								<h6>Deposit to:</h6>
								<div class="form-floating">
									<input type="text" name="txtnmDepositedAccountno" class="form-control" id="inputnmDepositedaccountno" placeholder="Partner Account" autocomplete="off" required style="background-color: #cccaca; border-color: transparent;">
									<label for="inputnmDepositedaccountno">Partner Account</label>
								</div>
								<table id="tblPartner" class="table table-hover table-light" style="width: 100%; display: none;">
									<tbody></tbody>
								</table>
								<div class="form-floating">
									<input type="text" name="txtnmDepositedpartner" class="form-control" id="inputnmDepositedpartner" placeholder="Partner" autocomplete="off" required style="background-color: #cccaca; border-color: transparent;">
									<label for="inputnmDepositedpartner">Partner</label>
								</div>
								<div class="form-floating">
									<input type="text" name="txtnmDepositedbank" class="form-control" id="inputnmDepositedbank" placeholder="Partner Account" autocomplete="off" required style="background-color: #cccaca; border-color: transparent;">
									<label for="inputnmDepositedbank">Partner Bank</label>
								</div>
							</div>
						</div>
					</form>
